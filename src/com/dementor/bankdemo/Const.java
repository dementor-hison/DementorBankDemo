...
public class Const {
	...
	public static final int BANK_INDEX_ETEX = BANK_INDEX_PAYNOW + 1;
	public static final int BANK_INDEX_DK = BANK_INDEX_ETEX + 1;
	
	public static final int CI_ICON_COUNT[] = {5, 6, 7, 0, 8, 7, 5, 0, 3, 6, 0, 5, 0, 25, 0, 9, 12};
	...
	public static final int COLORS_HIGHLIGHT[] = {
		...
		Color.rgb(109, 195, 151), Color.rgb(109, 195, 151), Color.rgb(109, 195, 151), Color.rgb(109, 195, 151), Color.rgb(109, 195, 151)};
	...
	public static final int BANK_ICON[] = {R.drawable.icon_sscard, R.drawable.icon_hn, R.drawable.icon_ibk, R.drawable.icon_jb, R.drawable.icon_kb,
		...
		R.drawable.icon_suh, R.drawable.icon_wr, R.drawable.icon_e, R.drawable.icon_china, R.drawable.icon_paynow, R.drawable.icon_etex, R.drawable.icon_dk};
	...
	public static final int BANK_INTRO[] = {R.drawable.bg_card_ss1, R.drawable.bg_hn1, R.drawable.bg_ibk1, R.drawable.bg_jb1, R.drawable.bg_kb1,
		...
		R.drawable.bg_wr1, R.drawable.bg_alipay1, R.drawable.bg_paynow1, R.drawable.bg_etex1, R.drawable.bg_dk1};
	...
	public static final int BANK_AUTH[] = {R.drawable.bg_card_ss2, R.drawable.bg_hn2, R.drawable.bg_ibk2, R.drawable.bg_jb2, R.drawable.bg_kb2,
		...
		R.drawable.bg_wr2, R.drawable.bg_alipay2, R.drawable.bg_paynow2, R.drawable.bg_etex2, R.drawable.bg_dk2};
	...
	public static final int BANK_MAIN[] = {R.drawable.bg_card_ss3, R.drawable.bg_hn3, R.drawable.bg_ibk3, R.drawable.bg_jb3, R.drawable.bg_kb3,
		...
		R.drawable.bg_wr3, R.drawable.bg_alipay3, R.drawable.bg_paynow3, R.drawable.bg_etex3, R.drawable.bg_dk3};
